...
const SLIDES = [
  { 
    ...
    isEvent: true,
    tag: "UPCOMING EVENT",
    title: "DISCOVER BISOKE VOLCANO", 
    subtitle: "Crater Lake • Volcanic Trails • Misty Rainforest",
    highlights: ["Incoming This May", "Full Package: 60K RWF", "Departure: CHIC (08:00 - 09:00 AM)"],
